        ...
        <div>
            ...
            <div className="grid place-items-center">
                <div className="relative z-10 w-full max-w-lg m-10 mb-24">
                    ...
                    <svg className="absolute -right-0 top-[90px] z-0 w-32 h-32 -mb-12 -mr-12 text-blue-600 fill-current" viewBox="0 0 91 91" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className="absolute -left-7 -bottom-0 z-0 w-32 h-32 -mb-12 -mr-12 text-blue-600 fill-current" viewBox="0 0 91 91" xmlns="http://www.w3.org/2000/svg">
                        <g stroke="none" stroke-width="1" fill-rule="evenodd">
                            <g fill-rule="nonzero">
                                <g>
                                    <g>
